...
const features = [
  { icon: "⚡", title: "Live Preview",       description: "See your CSS applied instantly as you type. No refresh needed." },
  { icon: "📐", title: "Axis Visualization", description: "Main axis and cross axis drawn on your layout in real time." },
  { icon: "💡", title: "Why It Works",       description: "Clear explanation after each level — not just the answer, but the reason." },
  { icon: "🧪", title: "Sandbox Mode",       description: "Free-play to experiment with any flex combination." },
];
  ...
  return (
    <>
      ...
      <main className="flex flex-col">
        ...
        >
          {/* Radial mint gradient */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background:
                "radial-gradient(ellipse 70% 60% at 50% 30%, rgba(5,150,105,0.07) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="mt-16 w-full max-w-sm">
            <p className="text-xs mb-3 uppercase tracking-widest" style={{ color: "var(--muted-lt)" }}>
              Live example
            </p>
            <div
        ...
        {/* ── Features ── */}
        <section className="px-6 py-24" style={{ background: "#f8fffe" }}>
          <div className="max-w-4xl mx-auto">
            <p className="text-xs font-semibold uppercase tracking-widest text-center mb-3" style={{ color: "var(--accent)" }}>
              Why FlexLab
            </p>
            <h2 className="text-3xl font-black text-center mb-12" style={{ color: "var(--text)" }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {chapters.map((ch) => (
                ...
                >
                  ...
                  <div className="font-bold text-sm mb-0.5" style={{ color: "var(--text)" }}>{ch.name}</div>
                  <div className="text-xs" style={{ color: "var(--muted)" }}>{ch.levels} levels</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── CTA ── */}
        <section className="px-6 py-32 text-center" style={{ background: "#f8fffe" }}>
        ...
        <footer
          ...
          style={{ color: "var(--muted-lt)", borderTop: "1px solid var(--border)" }}
        >
